...
async function solicitarCambioPassword (email) {
  ...
  await enviarCorreoVerificacion(usuarioBD, {
    ...
    text: `Hola ${usuarioBD.nombre}, usa el siguiente enlace para cambiar tu contraseña: https://intecca.uned.es/cyberhub/epalsafer/resetpassword/confirm/${resetToken}`,
    html: `<p>Hola <strong>${usuarioBD.nombre}</strong>,</p>
           <p>Haz clic en el siguiente enlace para cambiar tu contraseña:</p>
           <a href="https://intecca.uned.es/cyberhub/epalsafer/resetpassword/confirm/${resetToken}">Restablecer contraseña</a>`
  })
