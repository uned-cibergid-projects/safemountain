...
public class CodeInfoCollector {
    ...
    private boolean initialize() {
        ...
        try {
            File primordialFile = new File(ABSOLUTEPATH, BASIC_FILE);
            File stdJarFile = new File(ABSOLUTEPATH, STD_JAR);
            mScope = AnalysisScopeReader.readJavaScope(primordialFile.getAbsolutePath(), null, WALA_CLASSLOADER);
            mScope.addToScope(ClassLoaderReference.Primordial, new JarFile(stdJarFile));
